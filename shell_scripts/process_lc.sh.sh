#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Apr 27 16:28:43 BST 2022      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmi2 --mem-per-cpu=1000 nice -n 10 /mnt/zfsusers/shreshth/pht_project/code/pht-ml/shell_scripts/process_lc.sh 
